-- DROP table courses, departments, employees, professors, regions, sections, student_enrollment, students, teach, topics;
-- DELETE FROM django_migrations WHERE app='sql';
...
-- ALTER TABLE student_enrollment DROP CONSTRAINT student_enrollment_pkey;
...
-- ALTER TABLE teach DROP CONSTRAINT teach_pkey
